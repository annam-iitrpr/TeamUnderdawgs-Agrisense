...
- D001: Prepared pure calculations locally while the remote was empty. After the operator allowed temporary internals and asked to wait for Phase 3's commit, branched from its published `contract_v1` at `ff851c3`. Do not claim the full runtime bootstrap passed.
- D002: `reference_v1` reproduces source ambiguities; `advisory_v1` is an unvalidated dimensional heuristic. No invented product efficacy, local crop calendar, weather default, or calibration claim.

...
Facade benchmark: `PYTHONPATH=backend .venv/bin/python -W error science/evaluation/benchmark_facade.py`, 50 measured runs/5 warmups on arm64 Python 3.12.14. Season evaluation with 336 hours and scenario economics p95 11.015 ms; five-crop comparison with 365 climate days/20 paired source rows/2,000 draws each p95 2.483 ms. No IO, auth, worker or network included. No approved safety catalog is in the facade benchmark. The separate existing `benchmark.py` exercises candidate safety ranking.
